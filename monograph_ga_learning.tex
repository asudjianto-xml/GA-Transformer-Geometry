...
through two sub-components applied in sequence: self-attention and a
...
projected to a score for every word in the vocabulary (called \textbf{logits}) via a learned linear map. Higher logits mean higher probability. The
